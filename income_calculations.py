#sql database that stores data
#any other libraries 
#API stuff to send back to front end 
...
def calculate_expenses():
    # Get the income data from the request
    income_data = request.json
    income = income_data['income']

    # Call the main function with the income data
    main(income)

    # Return a response indicating success
    return jsonify({'message': 'Income processed successfully'})
def main(income): 
